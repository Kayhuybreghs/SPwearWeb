 ...
 * - Eager loading voor hero-afbeelding via CSS en preload
 * - Responsive backgrounds via CSS + <picture> voor preloading
...
const Hero = () => {
  ...
  return (
    <section className="relative h-screen flex items-center overflow-hidden">
      {/* Background via CSS achtergrond en preload */}
      <div
        className="absolute inset-0 bg-cover bg-center z-0"
        style={{ backgroundImage: "url('/Webstie-background.webp')" }}
        role="img"
        aria-label="Professionele bedrukte werkkleding van SPwear"
      >
        <picture>
